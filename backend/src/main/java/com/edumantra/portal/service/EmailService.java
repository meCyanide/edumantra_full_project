...
// return sendMail(to, "EduMantra Password Reset OTP", "Your EduMantra password
// reset OTP is: " + otp + "\n\nIt will expire soon. If you did not request
...
// has been created successfully. You can now sign in to EduMantra and continue
// your learning journey.");
// }

// public boolean sendMail(String to, String subject, String body) {
// if (mailSender == null) {
// logger.info("Email sending is not configured. To: {} | Subject: {} | Body:
// {}", to, subject, body);
// return true;
// }
